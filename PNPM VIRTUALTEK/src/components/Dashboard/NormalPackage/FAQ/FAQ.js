...
export default function FAQ({ data, mode }) {
  ...
  const { mutate: addFAQMutate, isLoading: loadingFAQMutate } = useEditFAQ(params._id)
  const { mutate: editUnitMutate, isLoading: loadingEditMutate } = useUnitEditFAQ(params._id)
  const { mutate: deleteUnitMutate, isLoading: loadingDeleteMutate } = useUnitDeleteFAQ(params._id)
