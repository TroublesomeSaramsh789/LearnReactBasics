...
// for api call
import { useDeleteTeam } from '../../../../services/websiteManagement';
import { useGetAllVirtualBooking } from '../../../../services/BookingService';
...
const VirtualBookingAdmin = () => {
  ...
  const { isLoading, isError, data } = useGetAllVirtualBooking({page, search:debounceSearch});
...
export default VirtualBookingAdmin;