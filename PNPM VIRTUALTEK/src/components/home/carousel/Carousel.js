        ...
        {slides.map((slide, index) => (
          <div key={index} className="h-[70vh] lg:h-[calc(70vh-40px)]">
            <div className="h-full relative">
              <img
                src={getImageAbsoluteURL(slide.image)}
                alt=""
              ...
              <div className="max-w-lg text-white absolute top-1/2 left-1/2 lg:left-56 -translate-x-1/2 lg:-translate-x-0 -translate-y-1/2">
                <p className="text-base">{slide.country}</p>
                ...
                <a
                  href={slide.link}
                  className="inline-block px-4 sm:px-10 py-1.5 rounded-md text-lg bg-white text-[#0C64A2] text-decoration-none  goVirtualButton"
                >
                  Go Virtual
                </a>
              </div>
